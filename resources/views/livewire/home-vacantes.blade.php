            ...
            <div class="bg-white shadow-sm rounded-lg p-6 divide-y divide-gray-200">
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            <a href="{{ route('vacantes.show', $vacante->id) }}" class="text-3xl font-bold text-gray-600">
                                {{ $vacante->titulo }}</a>
                        ...
                        <div class="mt-5 md:mt-0">
                            <a href="{{ route('vacantes.show', $vacante->id) }}"
                                class="bg-green-500 rounded-lg p-3 text-sm uppercase font-bold text-white block text-center">Ver
                                Vacante</a>
                        </div>
                    </div>
                @empty
